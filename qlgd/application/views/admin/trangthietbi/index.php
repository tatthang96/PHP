       ...
       <div class="widget">
        ...
        <table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tbody class="list_item">
                ...
                <tr class="row_9">
                    <td><input name="id[]" value="<?php echo $row->MaTTB ?>" type="checkbox"></td>

                    <td class="textC"><?php echo $row->MaTTB ?></td>
                    ...
                    <td class="option textC">
                        ...
                        <a href="<?php echo admin_url('trangthietbi/edit/'.$row->MaTTB) ?>" title="Chỉnh sửa" class="tipS">
                            <img src="<?php echo public_url('admin'); ?>/images/icons/color/edit.png">
                        </a>

                        <a href="<?php echo admin_url('trangthietbi/delete/'.$row->MaTTB) ?>" title="Xóa" class="tipS verify_action">
